        ...
        <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4 bg-black">
            <div className="flex flex-col lg:flex-row justify-between gap-8">
                <div className="w-full lg:w-5/12 flex flex-col justify-center">
                    <h1 className="text-3xl lg:text-4xl font-bold leading-9 text-slate-100 pb-4">About Us</h1>
                    <p className="font-normal text-base leading-6 text-slate-100 ">At Duka, we understand the importance of convenience and speed when shopping for your everyday essentials. Our platform is designed to provide you with a seamless experience, offering a wide range of high-quality FMCG products, from household necessities to personal care and groceries. Whether you need to restock your pantry, find the best deals on cleaning supplies, or get the latest personal hygiene products, we’ve got you covered.</p>
                </div>
